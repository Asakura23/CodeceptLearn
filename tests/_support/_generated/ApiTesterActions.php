<?php  //[STAMP] 2b5818181e8cd6a2ced7dc7b2f387ccf
...
trait ApiTesterActions
{
     ...
     *
     *
     * @see \Helper\Api::equalValue()
     */
    public function equalValue($expected, $actual, $message = "", $delta = 0.0) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('equalValue', func_get_args()));
    }
